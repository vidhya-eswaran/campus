  ...
  <sup class="req">*</sup>
                  ...
                  <div class="form-row row">
                     ...
                     <div class="col-lg-4 col-md-8" style="position:relative;">
                         <span class="par-span">Mr.</span>
                        <input type="text" name="father_name" placeholder="Enter Father's Name"
                           class="form-control form-control-sm" style="padding:.25rem 2.5rem">
                     </div>
                     <div class="col-lg-2 col-md-4">
                  ...
                  <div class="form-row row">
                     ...
                     <div class="col-lg-4 col-md-8" style="position:relative;">
                         <span class="par-span">Mrs.</span>
                        <input type="text" name="mother_name" id="mother_name" placeholder="Enter Mother's Name"
                           class="form-control form-control-sm" required style="padding:.25rem 3rem">
                     </div>
                     <div class="col-lg-2 col-md-4">
