...
Route::get('/email/check', function (Request $request) {
    $modulesToCheck = [
        ...
        'Fee Management - donation from Sponsor',
        'Hostel Admission',
        'Hostel Admission - application by parent',
        'Hostel Admission - update Status of hostel application',
    ];
    $results = [];
...
Route::get('/php', function () {
 ...
 Route::any('/source', function (Request $request) {
    return response()->json([
        ...
        'source'      => strpos($request->header('User-Agent'), 'PostmanRuntime') !== false ? 'Postman' : 'Browser/Other'
    ]);
});
...
//Route::get('/EditSVSUser', [listUserController::class, 'changeUserDetails']);
...
//User role or std or sec or group based list Route
...
Route::post('/upload-student', [StudentController::class, 'uploadStudentData'])
    ->middleware(['api', 'throttle:10000,1']);
...
// Route::post('/generate-pdf', [TemplateEditorController::class, 'generatePdf']);
//     //  Route::get('/generate-pdf', [TemplateEditorController::class, 'generatePdf']);
//     // Fetch all templates
...
//     Route::get('/{id}', [TemplateEditorController::class, 'show']);
    
//     // Delete a template
//     Route::delete('/{id}', [TemplateEditorController::class, 'destroy']);
    
//     // Download template as PDF
//     Route::get('/{id}/download-pdf', [TemplateEditorController::class, 'downloadPdf']);
    
//     // Preview template as PDF in browser
...
Route::prefix('message-category')->name('message-category.')->group(function () {
    Route::get('/', [MessageCategoryMasterController::class, 'index'])->name('index');
    Route::post('/', [MessageCategoryMasterController::class, 'store'])->name('store');
    Route::put('/{id}', [MessageCategoryMasterController::class, 'update'])->name('update');
...
Route::post('hostel-admissions/bulk-update-status', [HostelAdmissionController::class, 'bulkUpdateStatus'])->name('hostel-admissions.bulk-update-status');
Route::post('hostel-admissions/bulkArrialDepature', [HostelAdmissionController::class, 'bulkArrialDepature']) ;
Route::get('send-mails-bg/{filename}', [HostelAdmissionController::class, 'sendMailsBackground'])->name('hostel.sendMails.bg');


Route::post('storeSendForm', [HostelAdmissionController::class, 'storeSendForm']) ->middleware('throttle:1000,1');
