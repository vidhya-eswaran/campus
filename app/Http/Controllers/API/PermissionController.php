   ...
   public function index(Request $request)
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            // Truncate the module_permissions table before inserting new records
           // DB::table('module_permissions')->truncate();
            
            // Iterate through each permission in the payload
//             foreach ($request->input() as $item) {
//                 // Insert the parent permission
...
//                 // ]);
// $parentId = DB::table('module_permissions')->updateOrInsert(
//     [
//         'label' => $item['label'],
//         'parent_id' => null,
//         'menu_key' => $item['key'],
...
//                 // Insert children items if they exist
