...
class AnnouncementController extends Controller
{
 private $baseUrl;
    ...
    {
        $this->baseUrl = env('APP_URL', 'https://www.santhoshavidhyalaya.com/SVSTEST/');
    }
// Base URL without "public/"
    ...
    {
        $announcements = Announcement::with('categoryDetails')->orderBy('created_at', 'desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            $destinationPath = $_SERVER['DOCUMENT_ROOT'] . '/' . $folderName . '/announcements/'; // Store in public_html/announcements
    ...
    public function viewbyid($id)
    {
        ...
        // Convert file path to full URL
        if ($announcement->file) {
            $announcement->file = $this->base_url . 'announcements/' . $announcement->file;
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            if ($announcement->file) {
                ...
                $folderName = env('APP_FOLDER', 'SVSTEST'); // Default to 'SVSTEST' if not set in .env
               $oldFilePath = $_SERVER['DOCUMENT_ROOT'] . '/' . $folderName . '/announcements/' . $announcement->file;
...
$filePath = $_SERVER['DOCUMENT_ROOT'] . '/' . $folderName . '/announcements/' . $announcement->file;
