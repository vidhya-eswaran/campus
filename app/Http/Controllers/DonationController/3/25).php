...
//  dd( $paymentUrl);
 ...
 //dd($PaymentOrderDetails);
         ...
         $strNo = rand(1, 1000000);
             ...
             return redirect(route('donation.redirect'))->with('error', 'Payment processing failed.');
         }
     }
     public function donationRedirect()
     {
      
         return view('donation.success')->with('success', 'Admission Form Send Successfully!'); // Create a success page in resources/views/donation/success.blade.php
     }
