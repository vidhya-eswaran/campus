...
// dd($$payment_order_data);
        ...
        //New 
                ...
                { 
                    ...
                    $transactionRequestBean->amount = 300.00;
                    $transactionRequestBean->currencyCode = 'INR';
                    $transactionRequestBean->returnURL = $returnUrl;
                    $transactionRequestBean->shoppingCartDetails = env('SCHOOL_FEE_SCHEME_CDOE')."_".number_format(300.00,2,'.', '')."_".number_format(0.00,2,'.', '')."";
...
// });
    return view('admission.addedit')->with('success', 'Admission Form Send Successfully!');
...
Mail::send('emails.admissionMail', $admissionData, function ($message) use ($profile_pic, $profile_pic2, $profile_pic1,$profile_pic3,$profile_pic4,$profile_pic5,$profile_pic6,$profile_pic7,$profile_pic8,$profile_pic9,$profile_pic10)  {
    $message->to('admissions@santhoshavidhyalaya.com')->cc('udhayatech19@gmail.com','principal@santhoshavidhyalaya.com','prince@santhoshavidhyalaya.com')
        ->subject('Admission Form');
...
//dd($result);
    ...
    //$anotherMail = new AdmissionMail2($admissionData2);
...
// dd($result);
           ...
           return response()->json(['message' => 'Application Form is not send'], 404);
        }
     ...
     public function view($id)
    {
        ...
        $admission = Admission:: where('payment_order_id', 'LIKE', $id)
    ->orderBy('payment_order_id', 'asc')
    ->first();
    // dd($admission);
